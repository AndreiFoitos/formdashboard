 ...
 * resolve to `https://protocolapp.com/...` — they will 404 until you host the
...
export const PRIVACY_POLICY_URL = 'https://protocolapp.com/privacy'
export const TERMS_OF_SERVICE_URL = 'https://protocolapp.com/terms'
 ...
 */
export const SUPPORT_EMAIL = 'support@protocolapp.com'

...
VISION_SYSTEM = (
    ...
    "- For \"name\", use the simplest common food name in its raw/whole form "
    "(e.g. \"banana\", \"chicken breast\", \"rice\", \"olive oil\"). Do NOT add "
    "preparation modifiers like \"dehydrated\", \"powder\", \"chips\", \"dried\", "
    "or \"fried\" unless the food is actually in that processed form in the photo. "
    "These modifiers cause incorrect database matches.\n"
